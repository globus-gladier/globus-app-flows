...
class Collector(ABC):
    ...
    def __dict__(self):
        raise NotImplementedError("Collector does not implement dict")

    def __len__(self):
        raise NotImplementedError("Collector does not support item length")

    def get_item(self):
        raise NotImplementedError("Collector must implement this method!")

    def get_run_input(self, collection_data, form_data):
        raise NotImplementedError("Collector must implement the gut_run_input method!")

    def get_run_start_kwargs(self, collection_data, form_data):
        return {}

    def from_get_request(self, request, *args, **kwargs):
        raise NotImplementedError("Collector does not support this")

    def get_metadata(self):
        raise NotImplementedError("Collector does not implement this method.")
